// Kernel Utility Suit project from program 763.c to program775.c
//Sorting Algorithms
//Bubble Sort, Efficient Bubble Sort
...
void ArrayX :: BubbleSortEfficient()
{
    ...
    for(i = 0, pass = 1; i< this->iSize-1; i++, pass++)                   // Outer Loop
    {
        for(j = 0; j < this->iSize-1-i ; j++)           // Inner Loop
        {
            if(Arr[j] > Arr[ j + 1])
    ...
    cout<<"Number of passes for Bubble sort:"<<i+1<<"\n";
    this->Sorted = true;
}
