...
//                      Address of Buffer which comtains data,
//                      Size of data that we want to write
//  Output :            Number of bytes succreaafully written
//  Author :            Poorva Rohan Bhalerao
//  Date :              22/01/2026
//
//////////////////////////////////////////////////////////
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp("write", Command[0]) == 0)
            {
                ...
                iRet = WriteFile(atoi(Command[1]), InputBuffer,strlen(InputBuffer)- 1);                       // atoi = ascii to integer
