...
{
    public:
        int Addition(int No1, int No2)  //internally compiler will change the name suppose//Addition@2ii
        {
            return No1 +No2;
        }
...
int main()
{
    ...
    cout<<obj.Addition(80.90, 21.67)<<"\n";
    cout<<obj.Addition(11.11, 21.21, 31.31)<<"\n";
