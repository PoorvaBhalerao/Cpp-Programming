...
// Here two pointer are used which holds address of first member as well as last member of queue
...
void Queue :: enqueue(int no)               
{
    ...
    if(this->first == NULL && this->last == NULL)             // if Queue is empty
    {
        this->first = newn;
        this->last = newn;
    }
    ...
    {
        this->last->next = newn;
        this->last = newn;                                  // this->last = this->last->next;
    }
